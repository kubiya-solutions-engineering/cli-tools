...
OBSERVE_CLI_ICON_URL = "https://cdn.worldvectorlogo.com/logos/observe.svg"
...
class ObserveCLITool(Tool):
    """Base class for all Observe CLI tools."""
    ...
    icon_url: str = OBSERVE_CLI_ICON_URL
    type: str = "docker"
    ...
    def __init__(self, name, description, content, args=None, image="alpine:latest"):
        ...
        super().__init__(
            ...
            type="docker",
            secrets=["OBSERVE_API_KEYS", "OBSERVE_CUSTOMER_ID"],
            env=["OBSERVE_DATASET_IDS"],
            with_volumes=[{
