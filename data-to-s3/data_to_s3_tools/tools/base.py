...
DATA_PROCESSOR_ICON_URL = "https://cdn.worldvectorlogo.com/logos/python-5.svg"
...
class DataProcessorTool(Tool):
    """Base class for all data processing tools."""
    ...
    icon_url: str = DATA_PROCESSOR_ICON_URL
    type: str = "docker"
    ...
    def __init__(self, name, description, content, args=None, image="python:3.11-slim"):
        ...
        super().__init__(
            ...
            args=args or [],
            image=image,
            icon_url=DATA_PROCESSOR_ICON_URL,
            type="docker",
