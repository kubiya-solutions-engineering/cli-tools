...
GITHUB_CLI_ICON_URL = "https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png"
...
class GitHubCLITool(Tool):
    """Base class for all GitHub CLI tools."""
    ...
    icon_url: str = GITHUB_CLI_ICON_URL
    type: str = "docker"
